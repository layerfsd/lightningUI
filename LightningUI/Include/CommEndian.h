#ifndef _COMM_ENDIAN_H_
#define _COMM_ENDIAN_H_

#define COMM_TARGET_RT_LITTLE_ENDIAN			0
#define COMM_TARGET_RT_BIG_ENDIAN			1
//===========================================================================================================================
...
#if( COMM_TARGET_RT_LITTLE_ENDIAN )
...
#define	ChangePointWrite8( PTR, X ) \
	do \
	{ \
	Write8(PTR, X); \
	PTR += 1; \
...
#define	ChangePointWrite16( PTR, X ) \
	do \
	{ \
	WriteHost16(PTR, X); \
	PTR += 2; \
...
#define	ChangePointWrite24( PTR, X ) \
	do \
	{ \
	WriteHost24(PTR, X); \
	PTR += 3; \
...
#define	ChangePointWrite32( PTR, X ) \
	do \
	{ \
	WriteHost32(PTR, X); \
	PTR += 4; \
...
#define	ChangePointWrite48( PTR, X ) \
	do \
	{ \
	WriteHost48(PTR, X); \
	PTR += 6; \
...
#define	ChangePointWrite64( PTR, X ) \
	do \
	{ \
	WriteHost64(PTR, X); \
	PTR += 8; \
...
#define	ChangePointRead16( PTR, X ) \
	do \
	{ \
	X = ReadHost16(PTR); \
	PTR += 2; \
...
#define	ChangePointRead24( PTR, X ) \
	do \
	{ \
	X= ReadHost24(PTR); \
	PTR += 3; \
...
#define	ChangePointRead32( PTR, X ) \
	do \
	{ \
	X= ReadHost32(PTR); \
	PTR += 4; \
...
#define	ChangePointRead48( PTR, X ) \
	do \
	{ \
	X = ReadHost48(PTR); \
	PTR += 6; \
...
#define	ChangePointRead64( PTR, X ) \
	do \
	{ \
	X = ReadHost64(PTR); \
	PTR += 8; \
