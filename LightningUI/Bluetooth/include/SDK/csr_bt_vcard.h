...
#define CSR_BT_VCARD_DATA_TYPE_PHONETIC_NAME_UTF8                  (0x16)
#define CSR_BT_VCARD_DATA_TYPE_PHONETIC_NAME_UCS2                  (0x17)
...
typedef struct
{
    CsrCharString*                              firstName;
    CsrCharString*                              middleName;
    CsrCharString*                              lastName;
} CsrBtVcardDataPhoneticName;
...
typedef struct CsrBtVcardDataTypeRef
{
    ...
    union
    {
        CsrCharString*                          string;                 /* CSR_BT_VCARD_DATA_TYPE_STRING_UTF8 or CSR_BT_VCARD_DATA_TYPE_STRING_UCS2 */
        CsrBtVcardDataUriString*                uriString;              /* CSR_BT_VCARD_DATA_TYPE_URI_UTF8 or CSR_BT_VCARD_DATA_TYPE_URI_UCS2 */
        CsrBtVcardDataBinary*                   binary;                 /* CSR_BT_VCARD_DATA_TYPE_BINARY_UTF8 or CSR_BT_VCARD_DATA_TYPE_BINARY_UCS2 */
        CsrBtVcardDataAddress*                  address;                /* CSR_BT_VCARD_DATA_TYPE_ADDRESS_UTF8 or CSR_BT_VCARD_DATA_TYPE_ADDRESS_UCS2 */
        CsrBtVcardDataName*                     name;                   /* CSR_BT_VCARD_DATA_TYPE_NAME_UTF8 or CSR_BT_VCARD_DATA_TYPE_NAME_UCS2 */
        CsrBtVcardDataTelephone*                telephone;              /* CSR_BT_VCARD_DATA_TYPE_TELEPHONE_UTF8 or CSR_BT_VCARD_DATA_TYPE_TELEPHONE_UCS2 */
        CsrBtIso8601Date*                       iso8601Date;            /* CSR_BT_VCARD_DATA_TYPE_ISO8601_DATE */
        CsrBtIso8601DateTime*                   iso8601DateTime;        /* CSR_BT_VCARD_DATA_TYPE_ISO8601_DATETIME */
        CsrBtVcardDataLabel*                    label;                  /* CSR_BT_VCARD_DATA_TYPE_LABEL_UTF8 or CSR_BT_VCARD_DATA_TYPE_LABEL_UCS2 */
        CsrBtVcardDataTypedString*              typedString;            /* CSR_BT_VCARD_DATA_TYPE_TYPED_STRING_UTF8 or CSR_BT_VCARD_DATA_TYPE_TYPED_STRING_UCS2 */
        CsrBtVcardDataIso8601Date*              iso8601DateTyped;       /* CSR_BT_VCARD_DATA_TYPE_ISO8601_DATE_TYPED */
        CsrBtVcardDataIso8601DateTime*          iso8601DateTimeTyped;   /* CSR_BT_VCARD_DATA_TYPE_ISO8601_DATETIME_TYPED */
        CsrBtVcardDataOrganization*             organization;           /* CSR_BT_VCARD_DATA_TYPE_ORGANIZATION_UTF8 or CSR_BT_VCARD_DATA_TYPE_ORGANIZATION_UCS2 */
        void*                                   data;                   /* Entry used to optimize free functionality */
        CsrBtVcardDataPhoneticName*             phoneticName;           /* VCARD_DATA_TYPE_STRING_UTF8 or VCARD_DATA_TYPE_STRING_UCS2 */
    } payload;
} CsrBtVcardDataType;
...
typedef struct CsrBtVcardDataRef
{
    ...
    CsrBtVcardDataType*                         xPhoneticName;
} CsrBtVcardData;
...
void      CsrBtVcardFree(CsrBtVcardData* vcardData); /* Only for use with data returned from the parser */
