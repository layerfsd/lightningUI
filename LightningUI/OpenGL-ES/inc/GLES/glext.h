...
/*------------------------------------------------------------------------*
 * ADDED TO THIS FILE BY QUALCOMM
 *------------------------------------------------------------------------*/
...
/* FSL_EGL_image_external_layout_specifier */
#ifndef GL_FSL_EGL_image_external_layout_specifier
#define GL_FSL_EGL_image_external_layout_specifier 1
// YUV format
#define GL_YUV_FSL                                      GL_YUV_AMD
// YUV types
#define GL_UYVY_FSL                                     GL_UYVY_AMD
#define GL_NV21_FSL                                     GL_NV21_AMD
#define GL_YV12_FSL                                     GL_YV12_AMD
#endif
