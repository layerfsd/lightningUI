 ...
 ******************************************************************************
  File Name     : customer_daiichi_mitsubishi_l200.h
  ...
  2.Date		: 2016/7/20
  	Author		: wuhaoheng
	Modification: Added feature macro define for DAIICHI.
  3.Date		: 20160802
    Author		: wuhaoheng
	Modification: Use CVTE_MODEL_TYPE macro
******************************************************************************/

#ifndef __CUSTOMER_DAIICHI_MITSUBISHI_L200_H__
#define __CUSTOMER_DAIICHI_MITSUBISHI_L200_H__
...
//Show STW voltage value & net num
