 ...
 ******************************************************************************
  File Name     : customer_enterfront.h
  Version       : Initial Draft
  Author        : zhaoshunxian
  Created       : 2016/7/4
  Last Modified :
  Description   : customer_enterfront's configs file
  Function List :
  History       :
  1.Date        : 2016/7/4
    Author      : zhaoshunxian
...
#ifndef __CUSTOMER_ENTERFRONT_H__
#define __CUSTOMER_ENTERFRONT_H__
...
//Auto enter HOME page after ACC ON
#define CVTE_EN_AUTO_ENTER_HOME_PAGE_AFTER_ACCON	CVTE_ENABLE
...
//TimeZone 默认时区
#define CVTE_REG_TIMEZONE_DEFAULT	    CVTE_DEF_TIME_ZONE_GMT900_KOREA_STANDARD_TIME

//Navi Path
#define CVTE_REG_NAVI_PATH_DEFAULT	    _T("\\GPS CARD\\NaviOne\\NaviOne.exe")

//Bluetooth Device Name
#define CVTE_REG_BT_DEVICE_NAME_DEFAULT	    _T("ENTERFRONT AUTO")

//Radio Region
//CVTE_DEF_RADIO_REGION_MIN~CVTE_DEF_RADIO_REGION_MAX
#define CVTE_REG_RADIO_REGION_DEFAULT	    CVTE_DEF_RADIO_REGION_KOREAN
...
#define CVTE_REG_LANGUAGE_DEFAULT	    CVTE_DEF_LANGUAGE_KOREAN
...
#define CVTE_DEF_VEHICLE_DISPLAY_NAME	TEXT("CarPlay")
...
#endif /* __CUSTOMER_ENTERFRONT_H__ */
