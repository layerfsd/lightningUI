 ...
 ******************************************************************************
  File Name     : customer_hansong.h
  Version       : Initial Draft
  Author        : wuhaoheng
  Created       : 2017/06/28
  Last Modified :
  Description   : customer_hansong's configs file
  Function List :
  History       :
  1.Date        : 2017/06/28
    Author      : wuhaoheng
...
#ifndef __CUSTOMER_HANSONG_H__
#define __CUSTOMER_HANSONG_H__
...
/*************************      模块类型选择    *******************************/
/******************************************************************************/
#define CVTE_MODEL_TYPE			CVTE_MODEL_TYPE_U702P
...
#define CVTE_REG_RADIO_REGION_DEFAULT	    CVTE_DEF_RADIO_REGION_SOUTHAMERICA
