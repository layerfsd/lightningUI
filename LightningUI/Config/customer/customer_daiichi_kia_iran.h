 ...
 ******************************************************************************
  File Name     : customer_daiichi_kia_iran.h
  Version       : Initial Draft
  Author        : wuhaoheng
  Created       : 2017/01/10
  Last Modified :
  Description   : customer_daiichi_kia_iran's configs file
  Function List :
  History       :
  1.Date        : 2017/01/10
    Author      : wuhaoheng
...
#ifndef __CUSTOMER_DAIICHI_KIA_IRAN_H__
#define __CUSTOMER_DAIICHI_KIA_IRAN_H__
...
//TimeZone 默认时区
#define CVTE_REG_TIMEZONE_DEFAULT	    CVTE_DEF_TIME_ZONE_GMT330_IRAN_STANDARD_TIME
...
#define CVTE_REG_LANGUAGE_DEFAULT	    CVTE_DEF_LANGUAGE_PERSIAN
...
#endif /* __CUSTOMER_DAIICHI_KIA_IRAN_H__ */
