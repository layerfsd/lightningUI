 ...
 ******************************************************************************
  File Name     : customer_mapmyindia.h
  Version       : Initial Draft
  Author        : wuhaoheng 
  Created       : 2017/01/09
  Last Modified :
  Description   : customer_mapmyindia's configs file
  Function List :
  History       :
  1.Date		: 20170109
    Author		: wuhaoheng
...
#ifndef __CUSTOMER_MAPMYINDIA__
#define __CUSTOMER_MAPMYINDIA__
...
//TimeZone 默认时区
#define CVTE_REG_TIMEZONE_DEFAULT	    CVTE_DEF_TIME_ZONE_GMT530_INDIA_STANDARD_TIME
