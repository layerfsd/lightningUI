 ...
 ******************************************************************************
  File Name     : customer_itamco.h
  Version       : Initial Draft
  Author        : zhaoshunxian
  Created       : 2016/7/4
  Last Modified :
  Description   : customer_itamco's configs file
  Function List :
  History       :
  1.Date        : 2016/7/4
    Author      : zhaoshunxian
...
#ifndef __CUSTOMER_ITAMCO_H__
#define __CUSTOMER_ITAMCO_H__
...
//TimeZone 默认时区
#define CVTE_REG_TIMEZONE_DEFAULT	    CVTE_DEF_TIME_ZONE_GMT200_EGYPT_STANDARD_TIME

//Navi Path
#define CVTE_REG_NAVI_PATH_DEFAULT	    _T("\\GPS CARD\\NaviOne\\NaviOne.exe")

//Bluetooth Device Name
#define CVTE_REG_BT_DEVICE_NAME_DEFAULT	    _T("Elantra HD ")
...
#define CVTE_DEF_VEHICLE_DISPLAY_NAME		TEXT("Elantra HD")
