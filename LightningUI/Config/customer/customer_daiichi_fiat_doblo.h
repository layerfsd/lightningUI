 ...
 ******************************************************************************
  File Name     : customer_daiichi_fiat_doblo.h
  Version       : Initial Draft
  Author        : wuhaoheng
  Created       : 2016/8/17
  Last Modified :
  Description   : customer_daiichi_fiat_doblo's configs file
  Function List :
  History       :
  1.Date        : 2016/8/17
    Author      : wuhaoheng
...
#ifndef __CUSTOMER_DAIICHI_FIAT_DOBLO_H__
#define __CUSTOMER_DAIICHI_FIAT_DOBLO_H__
...
#endif /* __CUSTOMER_DAIICHI_FIAT_DOBLO_H__ */
