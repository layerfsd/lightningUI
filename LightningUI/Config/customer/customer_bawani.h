 ...
 ******************************************************************************
  File Name     : customer_bawani.h
  Version       : Initial Draft
  Author        : zhaoshunxian
  Created       : 2016/7/4
  Last Modified :
  Description   : customer_bawani's configs file
  Function List :
  History       :
  1.Date        : 2017/3/28
    Author      : wuhaoheng
...
#ifndef __CUSTOMER_BAWANI_H__
#define __CUSTOMER_BAWANI_H__
...
//TimeZone 默认时区
#define CVTE_REG_TIMEZONE_DEFAULT	    CVTE_DEF_TIME_ZONE_GMT400_ARABIAN_STANDARD_TIME
