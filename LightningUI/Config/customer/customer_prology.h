 ...
 ******************************************************************************
  File Name     : customer_prology.h
  Version       : Initial Draft
  Author        : zhaoshunxian
  Created       : 2016/7/4
  Last Modified :
  Description   : customer_prology's configs file
  Function List :
  History       :
  1.Date        : 2016/7/4
    Author      : zhaoshunxian
  ...
  2.Date		: 2017/4/17
  	Author		: wuhaoheng
	Modification: Prefect the config
******************************************************************************/

#ifndef __CUSTOMER_PROLOGY_H__
#define __CUSTOMER_PROLOGY_H__
...
/******************************************************************************/
//Font 默认字体
#define CVTE_REG_FONT_DEFAULT			CVTE_DEF_FONT_TYPE_SYMBOL
...
#define CVTE_REG_BT_DEVICE_NAME_DEFAULT	    _T("Prology")
...
//set audio codec samplerate to 44100
#define CVTE_DEF_AUDIO_CODEC_SAMPLERATE_44100	CVTE_ENABLE
...
/***************************   CVTE TV Widget 设置    *************************/
/******************************************************************************/
#define CVTE_DEF_TV_WIDGET_TYPE				CVTE_DEF_TV_WIDGET_TYPE_DVB

#define CVTE_TV_WIDGET_NAME_STRING			TEXT("DVB-T2")
