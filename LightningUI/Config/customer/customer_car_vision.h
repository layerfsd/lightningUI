 ...
 ******************************************************************************
  File Name     : customer_car_vision.h
  Version       : Initial Draft
  Author        : wuhaoheng
  Created       : 2016/7/20
  Last Modified :
  Description   : customer_car_vision's configs file
  Function List :
  History       :
  1.Date        : 2016/7/20
    Author      : wuhaoheng
...
#ifndef __CUSTOMER_CAR_VISION_H__
#define __CUSTOMER_CAR_VISION_H__
...
#endif /* __CUSTOMER_CAR_VISION_H__ */
