 ...
 ******************************************************************************
  File Name     : customer_daiichi_fiat_ducato.h
  Version       : Initial Draft
  Author        : wuhaoheng
  Created       : 2016/7/27
  Last Modified :
  Description   : customer_daiichi_fiat_ducato's configs file
  Function List :
  History       :
  1.Date        : 2016/7/27
    Author      : wuhaoheng
...
#ifndef __CUSTOMER_DAIICHI_FIAT_DUCATO_H__
#define __CUSTOMER_DAIICHI_FIAT_DUCATO_H__
...
#define CVTE_REG_BT_DEVICE_NAME_DEFAULT	    _T("Fiat Ducato")
...
/********************* CVTE_DEF_RELEASE_VERSION_NUM *************************/
#define CVTE_DEF_RELEASE_VERSION_NUM	2
...
#endif /* __CUSTOMER_DAIICHI_FIAT_DUCATO_H__ */
