 ...
 ******************************************************************************
  File Name     : customer_action.h
  Version       : Initial Draft
  Author        : zhaoshunxian
  Created       : 2016/7/4
  Last Modified :
  Description   : customer_action's configs file
  Function List :
  History       :
  1.Date        : 2016/7/4
    Author      : zhaoshunxian
...
#ifndef __CUSTOMER_ACTION_H__
#define __CUSTOMER_ACTION_H__
...
/************************* ACTION 模块类型选择 *******************************/
/******************************************************************************/
#define CVTE_MODEL_TYPE			CVTE_MODEL_TYPE_U702P_ASP	//CVTE_MODEL_TYPE_U701P_C
