 ...
 ******************************************************************************
  File Name     : customer_smartnavi.h
  Version       : Initial Draft
  Author        : wuhaoheng
  Created       : 2016/7/20
  Last Modified :
  Description   : customer_smartnavi's configs file
  Function List :
  History       :
  1.Date        : 2016/7/20
    Author      : wuhaoheng
...
//TimeZone 默认时区
#define CVTE_REG_TIMEZONE_DEFAULT	    CVTE_DEF_TIME_ZONE_600GMT_CENTRAL_STANDARD_TIME_MEXICO
