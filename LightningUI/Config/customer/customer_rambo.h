 ...
 ******************************************************************************
  File Name     : customer_rambo.h
  Version       : Initial Draft
  Author        : zhaoshunxian
  Created       : 2016/7/4
  Last Modified :
  Description   : customer_rambo's configs file
  Function List :
  History       :
  1.Date		: 2016/8/10
  	Author		: wuhaoheng
	Modification: Added feature macro definition for customer RAMBO.
******************************************************************************/

#ifndef __CUSTOMER_RAMBO_H__
#define __CUSTOMER_RAMBO_H__
...
/*************************       软件版本号     *******************************/
/******************************************************************************/
#define CVTE_DEF_APP_VERSION				"V1.1.3.1"
...
//TimeZone 默认时区
#define CVTE_REG_TIMEZONE_DEFAULT	    CVTE_DEF_TIME_ZONE_GMT700_SE_ASIA_STANDARD_TIME
