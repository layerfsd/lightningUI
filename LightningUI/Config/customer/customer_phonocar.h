 ...
 ******************************************************************************
  File Name     : customer_phonocar.h
  Version       : Initial Draft
  Author        : zhaoshunxian
  Created       : 2016/7/4
  Last Modified :
  Description   : customer_phonocar's configs file
  Function List :
  History       :
  1.Date        : 2016/7/4
    Author      : zhaoshunxian
...
#ifndef __CUSTOMER_PHONOCAR_H__
#define __CUSTOMER_PHONOCAR_H__
