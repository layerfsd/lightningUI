 ...
 ******************************************************************************
  File Name     : customer_autovision.h
  ...
  1.Date        : 2016/9/1
    Author      : wangyiping
    Modification: Created for customer Autovision for the firsttime.
  2.Data		: 2017/03/20
    Author		: wuhaoheng
	Modification: Modified for customer Autovision for the second sample. The modification detail plz refer to 
				  the sample single.
******************************************************************************/

#ifndef __CUSTOMER_AUTOVISION_H__
#define __CUSTOMER_AUTOVISION_H__
...
#define CVTE_DEF_VEHICLE_DISPLAY_NAME	TEXT("AutoVision CarPlay HU")
...
#endif /* __CUSTOMER_AUTOVISION_H__ */
