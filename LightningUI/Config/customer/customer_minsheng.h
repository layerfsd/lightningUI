 ...
 ******************************************************************************
  File Name     : customer_minsheng.h
  Version       : Initial Draft
  Author        : zhaoshunxian
  Created       : 2016/7/4
  Last Modified :
  Description   : customer_minsheng's configs file
  Function List :
  History       :
  1.Date        : 2016/7/4
    Author      : zhaoshunxian
  ...
  2.Date		: 2016/7/19
  	Author		: wuhaoheng
	Modification: Added feature macro define for MINSHENG.
  3.Date		: 20160802
    Author		: wuhaoheng
	Modification: Use CVTE_MODEL_TYPE macro
******************************************************************************/

#ifndef __CUSTOMER_MINSHENG_H__
#define __CUSTOMER_MINSHENG_H__
...
#define CVTE_EN_REAR_VOL_AUTO_ADJUSTMENT		CVTE_ENABLE
...
//Navi Path
#define CVTE_REG_NAVI_PATH_DEFAULT	    _T("\\GPS CARD\\Navi\\PaPaGO.exe")
