	...
	bool BeginThread(DWORD dwThreadOption = 0) 
	{
		...
		{//! 必须是没有线程在运行状态下才可以启动线程
			...
			if (dwOption_ & EN_THREAD)
			{
				...
				else
				{
					if (dwOption_ & EN_ABOVE_NORMAL)
						CeSetThreadPriority(hWatchThread_, CE_THREAD_PRIO_256_ABOVE_NORMAL);
				}
			}
			...
			if (dwOption_ & EN_RX_THREAD)
			{
				...
				{
					if (dwOption_ & EN_ABOVE_NORMAL)
						CeSetThreadPriority(hReadThread_, CE_THREAD_PRIO_256_ABOVE_NORMAL);
				}
			}
			...
			if (dwOption_ & EN_TX_THREAD)
			{
				...
				{
					if (dwOption_ & EN_ABOVE_NORMAL)
						CeSetThreadPriority(hWriteThread_, CE_THREAD_PRIO_256_ABOVE_NORMAL);
				}
			}
